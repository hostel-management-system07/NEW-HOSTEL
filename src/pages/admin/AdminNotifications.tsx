                ...
                <CardContent className="p-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      {(notification.studentName || notification.roomNumber) && (
                        <div className="mt-2 text-sm text-gray-600">
                          {notification.studentName && <p>Student: {notification.studentName}</p>}
                          {notification.roomNumber && <p>Room: {notification.roomNumber}</p>}
                        </div>
                      )}
                    </div>
                  </div>
